...
final class ToolRegistryService {
    ...
    private func registerBuiltinTools() {
        let registry: [(id: String, category: String, desc: String, aliases: [String], isNew: Bool)] = [
            ...
            ("system.lint",          "system",     "Run project-specific linter",                   ["lint"],                    true),
            ("system.format",        "system",     "Run project-specific formatter",                ["format"],                  true),
            ("system.test",          "system",     "Run project-specific tests",                    ["test"],                    true),
